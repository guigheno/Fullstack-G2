...
async function list(paging) { return repo.findAll(paging); }
async function getById(id) { const x = await repo.findById(id); if (!x) throw new NotFoundError('Category não encontrada.'); return x; }
